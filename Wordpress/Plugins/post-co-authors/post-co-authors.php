...
add_shortcode('co-authors', 'pcauthor_get_co_author');

add_action( 'admin_menu', 'pcauthor_my_plugin_menu' );

/*------------- Add plugin author setting option in setting tab ----------------*/
function pcauthor_my_plugin_menu() {
	add_options_page( 'Co Author Options', 'Co Authors', 'manage_options', 'co_author_options', 'pcauthor_co_author_options' );
}
